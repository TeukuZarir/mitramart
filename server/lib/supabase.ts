...
// Load .env.local in development, ignore in production (Vercel provides env vars)
...
if (!supabaseUrl || !supabaseKey) {
    ...
    console.error('   Available env keys:', Object.keys(process.env).filter(k => k.includes('SUPABASE') || k.includes('JWT')));
}
